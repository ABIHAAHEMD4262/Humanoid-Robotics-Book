...
Required secrets (configure in HF Space settings):

- `QDRANT_URL`: Qdrant cloud cluster URL
- `QDRANT_API_KEY`: Qdrant API key
- `GEMINI_API_KEY`: Google Gemini API key
- `OPENAI_API_KEY`: OpenAI API key
- `NEON_DATABASE_URL`: Neon Postgres URL (optional)
...
This Space is auto-deployed from the repository. Push to main branch to trigger deployment.
